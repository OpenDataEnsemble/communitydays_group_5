# Automotive — Group 5: agent and developer guide
...
- **Theme:** Automotive.
- **Register:** vehicle (`group_5_registration`).
- **Follow-up action:** Record a service (`group_5_followup`).
...
| Registration questions | `forms/group_5_registration/schema.json` and `ui.json` |
| Follow-up questions | `forms/group_5_followup/schema.json` and `ui.json` |
