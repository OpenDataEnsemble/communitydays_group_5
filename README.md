# Automotive App — Group 5

**ODE Community Days 2026, Kampala**

Register vehicles, open their details, and select **Record a service** to save a linked follow-up. Both forms ask only three questions.
...
- `forms/group_5_registration/`: registration schema and layout.
- `forms/group_5_followup/`: follow-up schema and layout.
...
1. Install the bundle in Formulus/Desktop and register two fictional vehicles.
2. Close each saved form: the table should update without pressing Refresh. Cancel a third form: no draft should appear.
3. Open the first row, select **Record a service**, and save. Its history should update; the second row must not show that follow-up.
